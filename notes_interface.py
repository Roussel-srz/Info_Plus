...
class NotesDialog(QDialog):
    ...
    def load_notes(self):
        ...
        header.resizeSection(3, 80)  # Largeur fixe, tu peux mettre 40 ou 50 si tu veux encore plus petit Importance
    def add_note(self):
    ...
    def edit_note(self, index):
        row = index.row()
        note_id = self.notes_manager.get_all_notes()[row][0]
        note_data = self.notes_manager.get_all_notes()[row][1:]
