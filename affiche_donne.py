...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # Table Widget
        self.tableWidget = self.create_table(20, 80, 1050, 450, parent=Form, 
                     column_count=9,
    ...
    def create_table(self, x, y, width, height, parent, column_count, headers):
        """Crée un QTableWidget avec les paramètres donnés."""
    ...
    def load_data(self, jour=None, month=None, year=None):
        ...
        try:
            ...
            color = 'blue' if reste >= 0 else 'red'
